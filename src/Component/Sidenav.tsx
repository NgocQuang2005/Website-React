...
const Sidenav = () => {
  ...
  return (
    <div >
        <AiOutlineMenu onClick={handleClick} className="fixed  right-4 top-4 z-[9999] md:hidden"/>
        {
            nav ? (
                <div className="fixed w-full h-screen bg-white/90 flex flex-col justify-center  items-center z-20 opacity-85">
